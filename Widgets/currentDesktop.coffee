...
render: (output) ->
  ...
  for i in [0..spaces.length - 1]
    icon = ""
    switch spaces[i]
        when '1' then icon = "./assets/icons/linux.svg"
        when '2' then icon = "./assets/icons/mozilla.svg"
        when '3' then icon = "./assets/icons/web-programming.svg"
        when '4' then icon = "./assets/icons/folder.svg"
        when '5' then icon = "./assets/icons/discord.svg"
        when '6' then icon = "./assets/icons/spotify.svg"
